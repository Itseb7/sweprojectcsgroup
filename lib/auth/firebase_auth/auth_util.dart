...
DocumentReference? get currentUserReference =>
    loggedIn ? UserDeatilsRecord.collection.doc(currentUser!.uid) : null;

UserDeatilsRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : UserDeatilsRecord.getDocument(UserDeatilsRecord.collection.doc(uid))
              .handleError((_) {}),
    )
    .map((user) {
